...
async function fold() {
    let p = await fetch(`https://github.com/Vibes-With-Tushar/test2/tree/main/css/Playlist`)
    console.log(p)
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].href.includes("Playlist")) {
            ...
            let p = await fetch(`https://github.com/Vibes-With-Tushar/test2/tree/main/css/Playlist/${folder}/info.json`)
